...
public class EditActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void start_edit() {
        String url = "这里是URl?mod=post&action=edit&tid=" + tid + "&pid=" + pid + "&mobile=2";
    ...
    private void startPost() {
        String url = "这里是URl?mod=post&action=edit&extra=&editsubmit=yes&mobile=2&handlekey=postform&inajax=1";
