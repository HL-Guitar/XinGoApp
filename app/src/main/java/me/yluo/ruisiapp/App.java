...
public class App extends Application {
    ...
    public static final String BASE_URL_ME = "http://rsbbs/";
    public static final String BASE_URL_RS = "http://rs";
    ...
    public static final String LOGIN_URL = "这里是member.php?mod=logging&action=login";
    public static final String LOGIN_RS = App.BASE_URL_RS + "这里是member.php?mod=logging&action=login&mobile=2";
    public static final String LOGIN_ME = App.BASE_URL_ME + "这里是member.php?mod=logging&action=login&mobile=2";

    public static final String CHECK_POST_URL = "这里是forum.php?mod=ajax&action=checkpostrule&ac=newthread&mobile=2";
    public static final String CHECK_UPDATE_URL = "这里是forum.php?mod=viewthread&tid=" + App.POST_TID + "&mobile=2";
